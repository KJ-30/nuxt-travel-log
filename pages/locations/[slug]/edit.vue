    ...
    <div class="drawer lg:drawer-open">
      ...
      <div class="drawer-content flex flex-col">
        <div class="navbar bg-base-100 shadow-sm">
          ...
          <div class="flex-1">
            <a class="btn btn-ghost text-xl">{{ isEdit ? "Edit Location" : "New Location" }}</a>
          </div>
        </div>

        <div class="flex-1 p-6">
          <div v-if="isEdit && pending" class="flex justify-center items-center h-64">
...
if (isEdit) {
  const { data: location, pending } = await useFetch(`/api/locations/slug/${slug}`);
